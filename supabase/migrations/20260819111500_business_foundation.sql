...
-- ADMIN: Technical/operational access (Full select, restricted write)
-- Note: ADMIN cannot gain Owner-only organization authority because the organizations table policy 
-- is restricted to is_owner(auth.uid()).
