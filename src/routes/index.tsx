          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <SectionCard title="Revenue Growth" className="h-[320px]">
              <div className="flex flex-col items-center justify-center h-full text-muted-foreground">
                ...
                <p className="text-xs opacity-60 italic">'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                            \n                                            Complete and production-refine the Customer Portal and Renewal Center for ABOS.\n\nFocus ONLY on Customer Portal and Renewals.\n\n1. Customer Portal Dashboard\n\nShow:\n\n- Customer name\n\n- Customer ID\n\n- Active subscription\n\n- Plan\n\n- Start date\n\n- Expiry date\n\n- Days remaining\n\n- Service health\n\n- Registered devices\n\n- Recent activity\n\n- Support status\n\n2. Subscription Workspace\n\nShow:\n\n- Current plan\n\n- Services included\n\n- Duration\n\n- Start/end dates\n\n- Renewal status\n\n- Subscription history\n\n- Upgrade/downgrade history\n\n3. Service Health\n\nProvide a clear customer-facing health view:\n\n- Active services\n\n- Service status\n\n- Usage information where available\n\n- Expiry information\n\n- Device status\n\nDo not fabricate service health or usage data.\n\n4. Customer Invoices\n\nCustomer can:\n\n- View invoices\n\n- Open invoice details\n\n- View payment status\n\n- View/download invoice PDF where available\n\nCustomer must NOT be able to edit financial records.\n\n5. Customer Documents\n\nShow only documents explicitly permitted for customer access.\n\n6. Customer Support\n\nCustomer can:\n\n- Create support request\n\n- View existing tickets\n\n- View ticket status\n\n- Reply to ticket\n\n- Upload permitted attachments\n\n7. Renewal Center\n\nInternal employee/admin workspace showing:\n\n- Renewals due today\n\n- 7 days\n\n- 30 days\n\n- Expired subscriptions\n\n- Renewal value\n\n- Assigned employee\n\n- Renewal stage\n\n- Last contact\n\n- Next follow-up\n\n- Renewal status\n\n8. Renewal Workflow\n\nSupport:\n\nUpcoming\n\n→ Contacted\n\n→ Interested\n\n→ Plan Selected\n\n→ Payment Pending\n\n→ Payment Verified\n\n→ Renewed\n\nAlso support:\n\n- Not Interested\n\n- Unreachable\n\n- Callback Requested\n\n- Expired\n\n- Lost\n\nKeep these statuses configurable by Admin.\n\n9. Renewal Customer 360\n\nShow:\n\n- Subscription\n\n- Previous plans\n\n- Payment history\n\n- Calls\n\n- Follow-ups\n\n- Support history\n\n- Devices\n\n- Notes\n\n- Renewal history\n\n10. Renewal Intelligence\n\nShow:\n\n- Renewal probability\n\n- At-risk customers\n\n- High-value renewals\n\n- Expiry concentration\n\n- Renewal conversion\n\nAI-generated predictions must be clearly separated from verified database facts.\n\n11. Renewal Actions\n\nAuthorized employees can:\n\n- Schedule callback\n\n- Add follow-up\n\n- Record call\n\n- Upload call recording\n\n- Send payment link\n\n- Add notes\n\n- Update renewal stage\n\n12. Customer Notifications\n\nPrepare UI/workflows for:\n\n- Expiry reminder\n\n- Renewal reminder\n\n- Payment confirmation\n\n- Renewal confirmation\n\n- Invoice notification\n\nUse configurable templates.\n\n13. Customer Portal Security\n\nStrictly enforce:\n\n- Customer can only access their own data.\n\n- No internal notes.\n\n- No employee performance information.\n\n- No internal audit information.\n\n- No internal payment verification notes.\n\n- No unauthorized documents.\n\n14. Admin Configuration\n\nMake configurable:\n\n- Renewal stages\n\n- Reminder intervals\n\n- Customer portal widgets\n\n- Customer-visible fields\n\n- Notification templates\n\n- Renewal assignment rules\n\n15. Universal Components\n\nUse existing:\n\n- Universal Timeline where appropriate\n\n- Universal Files\n\n- Universal Comments where appropriate\n\n- Universal Tags\n\n- Audit logging internally\n\n16. Enterprise UX\n\n- Premium responsive customer-facing interface.\n\n- Clear separation between Employee/Admin CRM and Customer Portal.\n\n- No placeholder business data.\n\n- No invented service-health information.\n\n- Preserve all approved workflows.\n\n- Do not modify unrelated modules.\n\n- Follow the existing ABOS design system.</p>
              </div>
            </SectionCard>
