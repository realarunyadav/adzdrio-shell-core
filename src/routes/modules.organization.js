...
import { Building2, Calendar, Image as ImageIcon, Grid, Layers, MapPin, Plus, Users, Map } from "lucide-react";
...
function OrganizationModule() {
    return (<div className="flex flex-col gap-6 p-6">
      <PageHeader eyebrow="Core Platform" title="Organization" description="Configure your business foundation, hierarchy and branding for the entire ABOS ecosystem." actions={<div className="flex items-center gap-2">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="h-auto w-full justify-start gap-4 overflow-x-auto bg-transparent p-0">
          <TabsTrigger value="overview" className="rounded-none border-b-2 border-transparent px-1 py-2 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:shadow-none">
            Overview
          </TabsTrigger>
          <TabsTrigger value="hierarchy" className="rounded-none border-b-2 border-transparent px-1 py-2 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:shadow-none">
            Hierarchy
          </TabsTrigger>
          <TabsTrigger value="locations" className="rounded-none border-b-2 border-transparent px-1 py-2 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:shadow-none">
            Locations
          </TabsTrigger>
          <TabsTrigger value="branding" className="rounded-none border-b-2 border-transparent px-1 py-2 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:shadow-none">
            Branding
          </TabsTrigger>
          <TabsTrigger value="calendar" className="rounded-none border-b-2 border-transparent px-1 py-2 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:shadow-none">
            Calendar
          </TabsTrigger>
        </TabsList>
              ...
              <SectionCard title="General Information" description="Basic details of the organization.">
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2 space-y-2">
                    ...
                    <Textarea id="description" placeholder="Enter a brief description of the organization..." className="min-h-[100px]"/>
                  </div>
                  <div className="space-y-2">
        ...
        <TabsContent value="hierarchy" className="mt-0 space-y-6">
          <div className="grid gap-6 lg:grid-cols-2">
            <SectionCard title="Departments" description="Manage functional areas of the business." actions={<AddDepartmentDialog />}>
              <EmptyState icon={Building2} title="No departments found" description="Start by creating departments to organize your workforce." className="py-8 surface-none border-none shadow-none"/>
            </SectionCard>

            <SectionCard title="Teams" description="Group employees within departments." actions={<Button size="sm" variant="outline"><Plus className="size-3.5 mr-1"/> Team</Button>}>
              <EmptyState icon={Users} title="No teams configured" description="Create teams to manage specific workgroups and project squads." className="py-8 surface-none border-none shadow-none"/>
            </SectionCard>

            <SectionCard title="Designations" description="Define job titles and role levels." className="lg:col-span-2" actions={<Button size="sm" variant="outline"><Plus className="size-3.5 mr-1"/> Designation</Button>}>
        ...
        <TabsContent value="locations" className="mt-0 space-y-6">
          <SectionCard title="Branches" description="Manage physical or regional business units." actions={<AddBranchDialog />}>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <EmptyState icon={Map} title="No branches active" description="Configure your headquarters and regional offices here." className="col-span-full py-12 surface-none border-none shadow-none"/>
            </div>
          </SectionCard>

          <SectionCard title="Office Locations" description="Detailed address and contact information.">
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <EmptyState icon={MapPin} title="Office list is empty" description="Addresses and contact info will appear here once branches are added." className="col-span-full py-12 surface-none border-none shadow-none"/>
            </div>
          </SectionCard>
        </TabsContent>
        ...
        <TabsContent value="calendar" className="mt-0 space-y-6">
          <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day) => (<Button key={day} variant={day === "Sun" || day === "Sat" ? "outline" : "default"} size="sm" className="w-12">
                        {day}
                      </Button>))}
                  </div>
            ...
            <SectionCard title="Holidays & Observances" description="Manage the company-wide holiday calendar." actions={<Button size="sm" variant="outline"><Plus className="size-3.5 mr-1"/> Holiday</Button>}>
              <EmptyState icon={Calendar} title="No holidays listed" description="The 2026 holiday calendar has not been configured yet." className="py-10 surface-none border-none shadow-none"/>
            </SectionCard>
          </div>
        </TabsContent>
      </Tabs>
...
function HealthCard({ title, value, icon: Icon }) {
    return (<Card className="bg-card shadow-sm border-border">
